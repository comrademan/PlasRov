...
parser.add_argument('--model', help='Folder that the saved model is located in',
                    default='C:/Users/kevin/Documents/Tensorflow/workspace/PlasRov/exported-models/my_tflite_model/saved_model')
parser.add_argument('--output', help='Folder that the tflite model will be written to',
                    default='C:/Users/kevin/Documents/Tensorflow/workspace/PlasRov/exported-tflite-models')
